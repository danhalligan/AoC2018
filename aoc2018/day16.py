...
dat = open("inputs/day16.txt").read()
...
def behaves_as(sample, poss=fns.keys()):
    return [fn for fn in poss if testfn(fns, fn, sample)]
...
def part2():
    # gather evidence
    poss = {k: list(fns.keys()) for k in range(16)}
